// Copied from ../../../typst-palimpsest/examples/emoji-email/ (the
// second of palimpsest's two full-length fake articles, this one
// against @preview/charged-ieee's two-column layout) and wired up for
// colophon too. See CLAUDE.md, "Examples with real palimpsest
// manuscripts".
...
#show: contexture.bundle.with(
  template: colophon.instrument(template: ieee.with(
  ...
  documents: (
    ...
    colophon.report(bib: "/typst-colophon/examples/emoji-email/manuscript.bib"),
  ),
)
